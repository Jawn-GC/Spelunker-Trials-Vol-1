...
-- Save the time of the run on death screen.
-- Only relevant if Speedrun Mode is disabled
local function save_time_on_death_screen()
...
level_sequence.activate = function()
	...
	add_callback(set_callback(save_time_on_death_screen, ON.DEATH))
